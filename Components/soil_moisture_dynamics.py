...
class SoilMoisture(Component):
    ...
    **Additional References**
    ...
    def initialize(
        ...
        intercept_cap_shrub=0,  ## based on sandy-clay-loam of Dingman tabel largely
        zr_shrub=0.35,
        I_B_shrub=10,
        I_V_shrub=10,
        pc_shrub=0.42,
    ...
    def update(self):
        ...
        self._fr = self._cell_values["vegetation__cover_fraction"]   #### this would need to be removed 
        ...
        for cell in range(0, self._grid.number_of_cells):
            ...
            if self._vegtype[cell] == 0:  # 0 - GRASS
                sc = scc            #* self._fr[cell] + (1 - self._fr[cell]) * fc     ##This is also edited for the NASA project
            else:
                sc = scc
